...
class Doubly_PluginCommon{
	 ...
	 */
	protected function putHtml_updateImagesButton(){

		if(GlobalsDOUBLY::$enableFrontImageCopy == false)
			return(false);
		
		$buttonText = __("Update Images","doubly");
		
		?>
		  		<a id="doubly_top_panel_button_update_images" class="doubly-front-top-panel__button-copy-style doubly-front-top-panel__button_update_images" href="javascript:void(0)">
	...
	protected function putHtml_copyPostButton(){
		...
		?>
		  		<a id="doubly_top_panel_button_copy" class="doubly-front-top-panel__button-copy-style doubly-front-top-panel__button_copy" href="javascript:void(0)">
	...
	public function onIncludeFrontScripts(){
		...
		if(GlobalsDOUBLY::$enableFrontImageCopy == true)
			HelperDOUBLY::addScript("doubly_front_image");
		...
		$showFloating = $this->isShowFloatingButtons();
		  ...
		  <div id="doubly_fron_top_panel" class="doubly-front-top-panel" style="display:none">
		    ...
		    <div id="doubly_top_panel_middle_text" class="doubly-front-top-panel--middle-text" style="display:none">
		  	...
		  	<?php $this->putHtml_updateImagesButton() ?>
